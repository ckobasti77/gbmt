...
const HomeFirst = () => {
  ...
  return (
    <div className="pt-24 h-screen w-screen bg-[url(/./mobile-bg.png)] lg:bg-[url(/./download.png)] bg-no-repeat bg-bottom bg-cover text-[#252525] overflow-hidden">
      <div className="flex flex-col items-center gap-y-6 px-6 lg:px-80 mt-8 ml-4">
        ...
        <h3 className="description z-40 opacity-0 translate-y-32 font-extrabold tracking-wide text-md lg:text-lg text-blue-600 text-center">
