...
const IskopiSecond = () => {
  return (
    <div className='w-screen px-6 lg:px-48 flex flex-col lg:flex-row gap-8 py-6 lg:py-0 justify-center items-center bg-[url(/./mobile-bg.png)] lg:bg-[url(/./background.png)] bg-no-repeat bg-bottom bg-cover'>
