...
const ScrollToTop = () => {
  ...
  return (
      ...
      <button
        className={`fixed backdrop-blur-2xl transition-all z-[99999999] bottom-14 lg:bottom-16 rounded-full text-white border-2 border-blue-500 w-14 h-14 grid place-items-center ${
          showScrollToTop
