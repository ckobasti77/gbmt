...
const Button = ({ to, text, className }) => {
  return (
    <Link
      ...
      to={to}
      className={`text-nowrap group opacity-0 translate-y-32 px-6 py-2 -skew-x-[15deg] border-blue-500 border-t-2 border-l-2 rounded-tl-xl rounded-br-xl hover:rounded-tl-none hover:rounded-tr-xl hover:rounded-br-none hover:rounded-bl-xl capitalize backdrop-blur-2xl text-white flex items-center justify-center font-bold ${className}`}
    >
