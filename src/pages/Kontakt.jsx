...
const Kontakt = () => {
  return (
    <div className="min-h-screen w-screen bg-[url(/./mobile-bg-2.png)] lg:bg-[url(/./background.png)] bg-no-repeat bg-bottom bg-cover">
      <Navbar />
      <div className="w-full h-full flex flex-col lg:flex-row items-center gap-x-8 px-6 lg:px-48 mt-24">
        <form action="" className="flex flex-col gap-y-8 w-full lg:w-1/2">
          ...
          <div className="flex flex-col">
            ...
            <textarea type="text" name="poruka" id="poruka" className="rounded-2xl" />
          </div>
